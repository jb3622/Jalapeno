namespace Disney.iDash.SPICE.Forms.EAS
{
    partial class SubmittedRequestsForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "SubmittedRequestsForm";
            this.Text = "EAS - Approved Requests";
