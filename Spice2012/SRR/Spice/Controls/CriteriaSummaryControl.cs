    ...
    public partial class CriteriaSummaryControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void SetValues(DetailedWorkbenchInfo workbenchInfo)
        {
            ...
            else
            {
				...
				if (workbenchInfo.AllMarkets || string.IsNullOrEmpty(workbenchInfo.Market))
					txtMarket.EditValue = "ALL";
				else if (workbenchInfo.Markets.Count > 0)
					txtMarket.EditValue = "SELECTED";
				else
            ...
            if (workbenchInfo.Promotions.Count == 0)
                ...
                txtPromotions.EditValue = "SELECTED";
