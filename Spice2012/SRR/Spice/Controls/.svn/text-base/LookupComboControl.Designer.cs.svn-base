namespace Disney.iDash.SPICE.Controls
{
    partial class LookupComboControl
    {
        ...
        {
			this.cboLookup = new DevExpress.XtraEditors.LookUpEdit();
			...
			this.cboLookup.Properties.AutoSearchColumnIndex = 1;
			this.cboLookup.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFit;
			...
			this.cboLookup.Properties.SearchMode = DevExpress.XtraEditors.Controls.SearchMode.AutoComplete;
        ...
        private DevExpress.XtraEditors.LookUpEdit cboLookup;
    }
}
